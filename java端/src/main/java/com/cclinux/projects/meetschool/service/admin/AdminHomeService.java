package com.cclinux.projects.meetschool.service.admin;
...
import com.cclinux.projects.meetschool.mapper.AdminMapper;
import com.cclinux.projects.meetschool.mapper.NewsMapper;
 ...
 */
@Service("MeetSchoolAdminHomeService")
public class AdminHomeService extends BaseMyAdminService {

    @Resource(name = "MeetSchoolAdminMapper")
    private AdminMapper adminMapper;

    @Resource(name = "MeetSchoolNewsMapper")
    ...
    @Resource(name = "MeetSchoolAdminMgrService")

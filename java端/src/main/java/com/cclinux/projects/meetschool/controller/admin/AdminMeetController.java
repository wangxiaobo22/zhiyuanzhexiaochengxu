...
import com.cclinux.projects.meetschool.service.admin.AdminMeetService;
import com.cclinux.projects.meetschool.service.cust.MeetService;
...
@RestController("MeetSchoolAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetSchoolAdminMeetService")
    private AdminMeetService adminMeetService;

    @Resource(name = "MeetSchoolMeetService")

package com.cclinux.projects.meetschool.controller.admin;
...
import com.cclinux.projects.meetschool.service.admin.AdminHomeService;
import com.cclinux.projects.meetschool.service.cust.PublicService;
...
@RestController("MeetSchoolAdminHomeController")
public class AdminHomeController extends BaseMyAdminController {

    @Resource(name = "MeetSchoolAdminHomeService")
    private AdminHomeService adminHomeService;

    @Resource(name = "MeetSchoolPublicService")

...
import com.cclinux.projects.meetschool.service.admin.AdminNewsService;
...
@RestController("MeetSchoolAdminNewsController")
public class AdminNewsController extends BaseMyAdminController {

    @Resource(name = "MeetSchoolAdminNewsService")

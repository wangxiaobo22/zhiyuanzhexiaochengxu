...
import com.cclinux.projects.meetschool.service.admin.AdminUserService;
...
@RestController("MeetSchoolAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "MeetSchoolAdminUserService")

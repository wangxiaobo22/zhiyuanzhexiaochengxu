...
-- ----------------------------
-- Table structure for meetschool_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_admin`;
CREATE TABLE `meetschool_admin`  (
...
INSERT INTO `meetschool_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetschool_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_fav`;
CREATE TABLE `meetschool_fav`  (
...
-- ----------------------------
-- Table structure for meetschool_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_meet`;
CREATE TABLE `meetschool_meet`  (
...
-- ----------------------------
-- Table structure for meetschool_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_meet_join`;
CREATE TABLE `meetschool_meet_join`  (
...
-- ----------------------------
-- Table structure for meetschool_news
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_news`;
CREATE TABLE `meetschool_news`  (
...
-- ----------------------------
-- Table structure for meetschool_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_setup`;
CREATE TABLE `meetschool_setup`  (
...
-- ----------------------------
-- Table structure for meetschool_user
-- ----------------------------
DROP TABLE IF EXISTS `meetschool_user`;
CREATE TABLE `meetschool_user`  (
